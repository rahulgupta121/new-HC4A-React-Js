        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-12 col-md-6 col-lg-6 donationBanner-div">
                ...
                <p  className="text-white mt-3 mb-3">Alienum phaedrum torquatos nec eu, vis detrax culis ex, nihis in mei.</p>
                </div>
                <div className="row">
                    <div className="col-sm-6 col-md-6 col-lg-6">
                        <p className="text-white mt-0 mb-0">Raised so far</p>
                        <h5 className="text-warning donation-font-weight mt-0">$1,200</h5>
                    </div>
                    <div className="col-sm-6 col-md-6 col-lg-6">
                        <p className="text-white mt-0 mb-0">Our Goal</p>
                        <h5 className="text-warning donation-font-weight mt-0 ">$5,000</h5> 
                    </div>
            ...
            <div className="col-sm-12 col-md-6 col-lg-6 content-part-2">
                ...
                <div className="row">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-12 col-md-7 col-lg-7 dollar-sign-100-div">
