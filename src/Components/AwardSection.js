...
<div className="card-background card">
  <div className="card-background-padding">
    <img src={presidentAward} className="president-award card-img-top"
      alt="..."/>
    <div className="card-inner card-body">
      <h5 className="card-title pt-2 text-white">The Award – Community Appreciation</h5>
      <p className='text-white'>In 2017, US President Donald Trump honored founder Harish Kotecha President’s “Lifetime Achievement
        Award”. The award reads “With grateful President’s Lifetime Achievement
        Award for their lifelong commitment to building a stronger nation through volunteer service.”</p>
    </div>
  </div>
</div>
</div>
        ...
        <div class="student-view-all-awards-btn">
          <button type="button" class=" btn btn-danger text-white"> VIEW ALL AWARDS</button>
        </div>
      </div>
