            ...
            <div className='Support-stud-banner-div'>
                    ...
                    <div className="row">
                        <div className="support-1-content-1 col-sm-12 col-md-4 col-lg-4">
                            <div className="supportBanner1-div">
                                 <img className='supportBanner1 rounded-circle' alt='' src={supportBanner1} />
                            </div>
                        ...
                        <div className="col-sm-12 col-md-8 col-lg-8 supportBanner2-div">
                            ...
                            <p className="text-black">School Supplies – Based on data from Texas Homeless Education Office, we identify the schools with homeless children needing most help. We then provide them the school supplies that they distribute to the students. We have provided school supplies to Austin, Manor, Del Valle ISDs and many other smaller organizations that are connected directly to homeless students.</p>                        
                            <p className="text-black">Vocational Training Scholarships – We provide broad guidelines to the institutions and entrust them to select students. The key points in the Guidelines are: The student must be living below federally definednts and some other organizations who work with students experiencing economic hardship</p>
                            
                            <div className='navbar-donate-div'>
                            <button  type="button" className="btn btn-danger navbar-donate-btn">
                                                                Learn more
                                    </button>
                            </div>
                ...
                <div className="container pt-5 pb-5">
                    <div className="row">
                        ...
                        <div className="support-1-content-1 col-sm-12 col-md-4 col-lg-4">
                            <div className="supportBanner1-div">
                                 <img className='supportBanner1 rounded-circle' alt='' src={handsImg} />
                            </div>
